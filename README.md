...
| -t, --threshold <double> | Threshold value applied to problem-specific information vector. |
...
We include two matrices from the [SuiteSparse Matrix Collection](https://sparse.tamu.edu/) in `mats/` for quick testing. Note that these require the `--force-symmetry` flag. 
